...
const Nav = () => (
    <div className='flex flex-col items-start col-span-2'>
      ...
      <Link activeClassName='link-active' to='/exercises/02_analyzing-data'>Exercise 2: Analyzing Vectors</Link>
      <Link activeClassName='link-active' to='/exercises/03_analyzing-raster'>Exercise 3: Analyzing Rasters</Link>
